                    ...
                    <li><a href="#" @click.prevent="$router.push('/chat')" class="iq-waves-effect"><i class="ri-message-fill"></i><span>Chat</span></a></li>
                     ...
                     <li class="active">
                        ...
                        <ul class="iq-submenu">
                           ...
                           <li class="active"><a href="#" @click.prevent="$router.push('/icon-remixicon')"><i class="ri-remixicon-fill"></i>Remixicon</a></li>
                     ...
                     <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                           ...
                           <div class="row mt-3">
                              ...
                              <div class="col-sm-6 col-md-4 col-lg-2">
                                 <a class="iq-icons-list" href="#"><i class="ri-tablet-fill"></i>tablet-line</a>
                              </div>
                              <div class="col-sm-6 col-md-4 col-lg-2">
                                 <a class="iq-icons-list" href="#"><i class="ri-tablet-fill"></i>tablet-fill</a>
                              </div>
                              <div class="col-sm-6 col-md-4 col-lg-2">
                                 <a class="iq-icons-list" href="#"><i class="ri-device-fill"></i>device-line</a>
                              </div>
                              <div class="col-sm-6 col-md-4 col-lg-2">
                              ...
                              <div class="col-sm-6 col-md-4 col-lg-2">
                                 <a class="iq-icons-list" href="#"><i class="ri-battery-low-fill"></i>battery-low-line</a>
                              </div>
                              <div class="col-sm-6 col-md-4 col-lg-2">

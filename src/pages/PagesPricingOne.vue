                    ...
                    <li><a href="#" @click.prevent="$router.push('/chat')" class="iq-waves-effect"><i class="ri-message-fill"></i><span>Chat</span></a></li>
                     ...
                     <li class="active">
                        ...
                        <ul class="iq-submenu">
                           ...
                           <li class="active"><a href="#" @click.prevent="$router.push('/pages-pricing-one')"><i class="ri-price-tag-2-fill"></i>Pricing 1</a></li>
               ...
               <div class="row">
                  ...
                  <div class="col-lg-3">
                     <div class="card bg-dark text-white text-center iq-mb-3">
                        <img src="/assets/images/page-img/25.jpg" class="card-img rounded" alt="#">
                  ...
                  <div class="col-lg-3">
                     <div class="card bg-dark text-white text-center iq-mb-3">
                        <img src="/assets/images/page-img/26.jpg" class="card-img rounded" alt="#">
                        <div class="card-img-overlay">
                           <h2 class="mb-4 display-3 font-weight-bolder text-white">19<small class="font-size-14 text-white">$ / Month</small></h2>
                           <ul class="list-unstyled line-height-4 mb-0 ">
                              <li>Lorem ipsum dolor sit amet</li>
                  ...
                  <div class="col-lg-3">
                     <div class="card bg-dark text-white text-center iq-mb-3">
                        <img src="/assets/images/page-img/27.jpg" class="card-img rounded" alt="#">
                        <div class="card-img-overlay">
                           <h2 class="mb-4 display-3 font-weight-bolder text-white">19<small class="font-size-14 text-white">$ / Month</small></h2>
                           <ul class="list-unstyled line-height-4 mb-0 ">
                              <li>Lorem ipsum dolor sit amet</li>
                  ...
                  <div class="col-lg-3">
                     <div class="card bg-dark text-white text-center iq-mb-3">
                        <img src="/assets/images/page-img/28.jpg" class="card-img rounded" alt="#">
                        <div class="card-img-overlay">
                           <h2 class="mb-4 display-3 font-weight-bolder text-white">19<small class="font-size-14 text-white">$ / Month</small></h2>
                           <ul class="list-unstyled line-height-4 mb-0 ">
                              <li>Lorem ipsum dolor sit amet</li>

                        ...
                        <div class="iq-card-body">
                           <ul id="doster-list-slide" class="d-flex flex-wrap align-items-center p-0">
                              <li class="docter-list-item col-md-3 text-center p-2">
                                 <div class="docter-list-item-inner rounded">
                                    <div class="donter-profile">
                                       <img src="/assets/images/user/05.jpg" class="img-fluid rounded-circle" alt="user-img">
                                    </div>
                              ...
                              <li class="docter-list-item col-md-3 text-center p-2">
                                 <div class="docter-list-item-inner rounded">
                                    <div class="donter-profile">
                                       <img src="/assets/images/user/06.jpg" class="img-fluid rounded-circle" alt="user-img">
                                    </div>
                                    <div class="doctor-detail mt-3">
                                       <h5>Dr. Paul Molive</h5>
                                       <h6>Nurse</h6>
                              ...
                              <li class="docter-list-item col-md-3 text-center p-2">
                                 <div class="docter-list-item-inner rounded">
                                    <div class="donter-profile">
                                       <img src="/assets/images/user/07.jpg" class="img-fluid rounded-circle" alt="user-img">
                                    </div>
                                    <div class="doctor-detail mt-3">
                                       <h5>Dr. Paul Molive</h5>
                                       <h6>Surgeon</h6>
                              ...
                              <li class="docter-list-item col-md-3 text-center p-2">
                                 <div class="docter-list-item-inner rounded">
                                    <div class="donter-profile">
                                       <img src="/assets/images/user/08.jpg" class="img-fluid rounded-circle" alt="user-img">
                                    </div>
                                    <div class="doctor-detail mt-3">
                                       <h5>Dr. Paul Molive</h5>
                                       <h6>Doctor</h6>
                              ...
                              <li class="docter-list-item col-md-3 text-center p-2">
                                 <div class="docter-list-item-inner rounded">
                                    <div class="donter-profile">
                                       <img src="/assets/images/user/09.jpg" class="img-fluid rounded-circle" alt="user-img">
                                    </div>
                                    <div class="doctor-detail mt-3">
                                       <h5>Dr. Paul Molive</h5>
                                       <h6>Surgeon</h6>
                              ...
                              <li class="docter-list-item col-md-3 text-center p-2">
                                 <div class="docter-list-item-inner rounded">
                                    <div class="donter-profile">
                                       <img src="/assets/images/user/10.jpg" class="img-fluid rounded-circle" alt="user-img">
                                    </div>
                                    <div class="doctor-detail mt-3">
                                       <h5>Dr. Paul Molive</h5>
                                       <h6>OT Assistent</h6>

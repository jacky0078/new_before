                  ...
                  <ul class="iq-menu">
                     ...
                     <li class="active">
                        ...
                        <ul class="iq-submenu">
                           ...
                           <li class="active"><a href="#" @click.prevent="$router.push('/email-compose')"><i class="ri-edit-2-fill"></i>Email Compose</a></li>
                        </ul>
                     </li>
                     <li>
                        ...
                        <ul class="iq-submenu">
                           <li><a href="#" @click.prevent="$router.push('/profile')"><i class="ri-profile-line"></i>Doctor Profile</a></li>
                           <li><a href="#" @click.prevent="$router.push('/add-doctor')"><i class="ri-user-add-line"></i> Add Doctor</a></li>
                           <li><a href="#" @click.prevent="$router.push('/profile-edit')"><i class="ri-file-edit-line"></i> Edit Doctor</a></li>
                           <li><a href="#" @click.prevent="$router.push('/doctor-list')"><i class="ri-file-list-line"></i>Doctor List</a></li>
                        </ul>
                     </li>
                     <li><a href="#" @click.prevent="$router.push('/calendar')" class="iq-waves-effect"><i class="ri-calendar-2-line"></i><span>Calendar</span></a></li>
                     ...
                     <li>
                        ...
                        <ul class="iq-submenu">
                           ...
                           <li><a href="#" @click.prevent="$router.push('/data-table')"><i class="ri-database-fill"></i>Data Table</a></li>
                     ...
                     <li>
                        ...
                        <ul class="iq-submenu">
                           ...
                           <li><a href="#" @click.prevent="$router.push('/pages-lock-screen')"><i class="ri-lock-line"></i>Lock Screen</a></li>
                        </ul>
                     </li>
                     <li>
                     ...
                     <li>
                        ...
                        <ul class="iq-submenu">
                           <li><a href="#" @click.prevent="$router.push('/pages-timeline')"><i class="ri-map-pin-time-line"></i>Timeline</a></li>
                           <li><a href="#" @click.prevent="$router.push('/pages-invoice')"><i class="ri-question-answer-line"></i>Invoice</a></li>

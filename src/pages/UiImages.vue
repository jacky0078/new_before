                    ...
                    <li><a href="#" @click.prevent="$router.push('/chat')" class="iq-waves-effect"><i class="ri-message-fill"></i><span>Chat</span></a></li>
                     ...
                     <li class="active">
                        ...
                        <ul class="iq-submenu">
                           ...
                           <li class="active"><a href="#" @click.prevent="$router.push('/ui-images')"><i class="ri-image-fill"></i>Images</a></li>
                  ...
                  <div class="col-sm-12 col-lg-6">
                     <div class="iq-card">
                        ...
                        <div class="iq-card-body">
                           ...
                           <img src="/assets/images/page-img/12.jpg" class="rounded-circle ml-3" alt="Responsive image">
                        </div>
                     </div>
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">

                    ...
                    <li><a href="#" @click.prevent="$router.push('/chat')" class="iq-waves-effect"><i class="ri-message-fill"></i><span>Chat</span></a></li>
                     ...
                     <li class="active">
                        ...
                        <ul class="iq-submenu">
                           ...
                           <li class="active"><a href="#" @click.prevent="$router.push('/pages-invoice')"><i class="ri-question-answer-fill"></i>Invoice</a></li>
                  ...
                  <div class="col-sm-12">
                     <div class="iq-card">
                        <div class="iq-card-body">
                           <div class="row">
                              <div class="col-lg-6">
                                 <img src="/assets/images/logo1.png" class="img-fluid w-25" alt="">
                              </div>
                              ...
                              <div class="col-sm-12">
                                 <hr class="mt-3">
                                 <h5 class="mb-0">Hello, Bini Jetss</h5>
                                          ...
                                          <tr>
                                             ...
                                             <td>
                                                <p class="mb-0">PO Box 16122 Collins Street West<br>Victoria 8007 Australia<br>
                                                   ...
                                                   Email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6004050d0f20383201194e030f0d">[email&#160;protected]</a><br>
                                                   Web: www.XRay.com
                                                </p>
                                             </td>
                                             <td>
                                                <p class="mb-0">PO Box 16122 Collins Street West<br>Victoria 8007 Australia<br>
                                                   Phone: +123 456 7890<br>
                                                   Email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="2a4e4f47456a72784b5304494547">[email&#160;protected]</a><br>
                                                   Web: www.XRay.com
                                                </p>
                                             </td>
                                          </tr>

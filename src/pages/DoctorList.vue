               ...
               <nav class="iq-sidebar-menu">
                  <ul class="iq-menu">
                     ...
                     <li class="active">
                        ...
                        <ul class="iq-submenu">
                           <li class="active"><a href="#" @click.prevent="$router.push('/doctor-list')"><i class="ri-file-list-fill"></i>All Doctors</a></li>
               ...
               <div class="row">
                     ...
                     <div class="iq-card">
                        <div class="iq-card-header d-flex justify-content-between">
                           <div class="iq-header-title">
                              <h4 class="card-title">Docters List</h4>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="col-sm-6 col-md-3">
                     <div class="iq-card">
                        <div class="iq-card-body text-center">
                           ...
                           <a href="#" @click.prevent="$router.push('/profile')" class="btn btn-primary">View Profile</a>
                        </div>
                     </div>
                  </div>
                  <div class="col-sm-6 col-md-3">
                  ...
                  <div class="col-sm-6 col-md-3">
                     <div class="iq-card">
                        <div class="iq-card-body text-center">
                           <div class="doc-profile">
                              <img class="rounded-circle img-fluid avatar-80" src="/assets/images/user/16.jpg" alt="profile">
                           </div>
                           <div class="iq-doc-info mt-3">
                  ...
                  <div class="col-sm-6 col-md-3">
                     <div class="iq-card">
                        <div class="iq-card-body text-center">
                           <div class="doc-profile">
                              <img class="rounded-circle img-fluid avatar-80" src="/assets/images/user/17.jpg" alt="profile">
                           </div>
                           <div class="iq-doc-info mt-3">
                              <h4> Dr. Hal Appeno </h4>
                              <p class="mb-0" >MD</p>
                  ...
                  <div class="col-sm-6 col-md-3">
                     <div class="iq-card">
                        <div class="iq-card-body text-center">
                           <div class="doc-profile">
                              <img class="rounded-circle img-fluid avatar-80" src="/assets/images/user/18.jpg" alt="profile">
                           </div>
                           <div class="iq-doc-info mt-3">
                              <h4> Dr. Polly Tech</h4>
